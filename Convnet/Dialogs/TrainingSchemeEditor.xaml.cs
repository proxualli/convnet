            ...
            for (int i = 0; i < DataGridRates.Columns.Count; i++)
            {
                ...
                for (int j = 0; j < DataGridRates.Columns.Count; j++)
                    if (DataGridRates.Columns[j].Header.ToString().Equals(name))
                    {
                        ...
                        {
                            case 22:
                                DataGridRates.Columns[j].DisplayIndex = 0;
                                break;
                            case 6:
                                DataGridRates.Columns[j].DisplayIndex = 1;
                                break;
                            case 7:
                                DataGridRates.Columns[j].DisplayIndex = 2;
                                break;
                            case 23:
                                DataGridRates.Columns[j].DisplayIndex = 3;
                                break;
                            case 24:
                                DataGridRates.Columns[j].DisplayIndex = 4;
                                break;

                            case 0:
                                DataGridRates.Columns[j].DisplayIndex = 5;
                                break;
                            case 1:
                                DataGridRates.Columns[j].DisplayIndex = 6;
                                break;
                            case 2:
                                DataGridRates.Columns[j].DisplayIndex = 7;
                                break;
                            case 3:
                                DataGridRates.Columns[j].DisplayIndex = 8;
                                break;
                            case 4:
                                DataGridRates.Columns[j].DisplayIndex = 9;
                                break;
                            case 5:
                                DataGridRates.Columns[j].DisplayIndex = 10;
                                break;
                            case 16:
                                DataGridRates.Columns[j].DisplayIndex = 11;
                                break;
                            case 17:
                                DataGridRates.Columns[j].DisplayIndex = 12;
                                break;
                            case 10:
                                DataGridRates.Columns[j].DisplayIndex = 13;
                                break;
                            case 11:
                                DataGridRates.Columns[j].DisplayIndex = 14;
                                break;
                            case 12:
                                DataGridRates.Columns[j].DisplayIndex = 15;
                                break;
                            case 13:
                                DataGridRates.Columns[j].DisplayIndex = 16;
                                break;
                            case 14:
                                DataGridRates.Columns[j].DisplayIndex = 17;
                                break;
                            case 15:
                                DataGridRates.Columns[j].DisplayIndex = 18;
                                break;
                            case 8:
                                DataGridRates.Columns[j].DisplayIndex = 19;
                                break;
                            case 9:
                                DataGridRates.Columns[j].DisplayIndex = 20;
                                break;
                            case 18:
                                DataGridRates.Columns[j].DisplayIndex = 21;
                                break;
                            case 19:
                                DataGridRates.Columns[j].DisplayIndex = 22;
                                break;
                            case 20:
                                DataGridRates.Columns[j].DisplayIndex = 23;
                                break;
                            case 21:
                                DataGridRates.Columns[j].DisplayIndex = 24;
                                DataGridRates.Columns[j].Visibility = Visibility.Hidden;
                                break;
                            case 25:
                                DataGridRates.Columns[j].DisplayIndex = 25;
                                DataGridRates.Columns[j].Visibility = Visibility.Hidden;
                                break;
                        }
