    ...
    public:
        ...
        static std::string Generate(const ScriptParameters p)
        {
            ...
            auto net =
                ...
                "WeightsFiller=" + to_string(p.WeightsFiller) + (!ScaleVisible(p.WeightsFiller) ? "(" + p.WeightsFillerMode.ToString() + ")" : "") + (ScaleVisible(p.WeightsFiller) ? "(" + to_string(p.WeightsScale) + ")" : "") + nwl +
